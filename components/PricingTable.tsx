...
export default function PricingTable({
  headline = 'Pricing for Every Fashion Journey',
  subheadline = 'Choose the perfect plan for styling, wardrobe curation, and exclusive drops.',
  tiers = [],
      ...
      <div className="container mx-auto max-w-7xl px-4 animate-fade-in-up">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          {tiers.map(function (tier, i) {
            return (
              <Card key={i} className={'card-hover relative flex flex-col ' + (tier.highlighted ? 'border-primary ring-2 ring-primary scale-105' : 'border-border')}>
                {tier.highlighted && (
