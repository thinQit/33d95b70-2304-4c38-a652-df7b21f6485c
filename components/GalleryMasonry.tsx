...
export default function GalleryMasonry({
  headline = 'Lookbook Gallery',
  subheadline = 'A curated visual diary of silhouettes, textures, and signature styling moments.',
  images = [],
      ...
      <div className="container mx-auto max-w-7xl px-4 animate-fade-in-up">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {images.map(function (img, i) {
            return (
              <div key={i} className="group card-hover relative aspect-square cursor-pointer overflow-hidden rounded-xl" onClick={function () { setSelectedImage(img); }}>
